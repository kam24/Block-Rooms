...
public class ExitPresenter : CellPresenter
{
    [SerializeField] private GameObject playerImmitation;

    private PlayerBallPresenter player;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (isCell && cellPresenter is PlayerBallPresenter playerBallPresenter && cellPresenter.Behavior is PlayerMovement movement)
        {
            player = playerBallPresenter;
